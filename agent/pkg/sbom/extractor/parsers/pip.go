...
func (p *PipParser) Parse(fs *extractor.Filesystem) ([]extractor.Package, error) {
...
func (p *PipParser) parseRequirements(content []byte) ([]extractor.Package, error) {
	packages := make([]extractor.Package, 0)
...
func (p *PipParser) parseMetadata(content []byte) (extractor.Package, error) {
	pkg := extractor.Package{Type: "pypi"}
