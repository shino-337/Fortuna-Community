...
func (p *GoModParser) Parse(fs *extractor.Filesystem) ([]extractor.Package, error) {
...
func (p *GoModParser) parseGoSum(content []byte) ([]extractor.Package, error) {
	packages := make([]extractor.Package, 0)
...
func (p *GoModParser) parseGoMod(content []byte) ([]extractor.Package, error) {
	packages := make([]extractor.Package, 0)
