...
//	  (integration tests live alongside worker packages as needed)
...
// TC-REAL-003: risk-center / npm supply-chain — package version matches malware row in DB (Aikido-style feed).
...
// TC-REAL-004: Same SBOM: CVE from Postgres (debian zlib) + malware (evil-pkg) — both paths hit.
