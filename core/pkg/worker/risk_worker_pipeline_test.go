...
func TestRiskWorker_Process_NormalizedPodMessage_EndToEnd(t *testing.T) {
	...
	if err := db.AutoMigrate(&models.AssetSecurityState{}, &models.RuntimeSignal{}, &models.PodCapability{}, &models.RoleBinding{}, &models.ClusterRoleBinding{}, &models.AuditLog{}, &models.Cluster{}, &models.Pod{}, &models.Insight{}, &models.RiskScore{}); err != nil {
		t.Fatal(err)
	}
