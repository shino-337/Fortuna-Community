...
type Cluster struct {
	...
	// Sensitivity is governance classification: public | internal | restricted | critical (RBAC governance; enforcement hooks expand over time).
	Sensitivity  string         `gorm:"size:32;default:internal;index" json:"sensitivity,omitempty"`
