...
CREATE INDEX IF NOT EXISTS idx_attack_paths_pod_uid    ON attack_paths(pod_uid);
CREATE INDEX IF NOT EXISTS idx_attack_paths_total_risk ON attack_paths(total_risk DESC);
`
