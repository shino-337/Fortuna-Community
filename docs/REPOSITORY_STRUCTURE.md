...
- `End-to-end-testcase-verify-05012026.md` - E2E test spec

**Local Only (excluded):**
- `06-reference/` - Reference materials
- `04-development/` - Development guides
- `05-operations/` - Operations (except current troubleshooting)
- `test-results/` - Generated test reports
- `02-architecture/` - Detailed architecture (except main ARCHITECTURE.md)
