...
-- Last updated: 2026-04-03 (migration 113: malware tables)
...
-- Note: users table is kept so admin credentials survive a DB reset.
-- Core migrations use CREATE TABLE IF NOT EXISTS / AutoMigrate, so re-starting Core recreates all tables.
