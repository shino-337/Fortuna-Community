...
-- Usage: kubectl cp deploy/sql/067_expand_package_vuln_version_columns.sql fortuna/<postgres-pod>:/tmp/ && kubectl exec -n fortuna <postgres-pod> -- psql -U postgres -d fortuna -f /tmp/067_expand_package_vuln_version_columns.sql
