...
-- Usage: kubectl cp deploy/sql/ensure_cve_tables.sql fortuna/<postgres-pod>:/tmp/ && kubectl exec -n fortuna <postgres-pod> -- psql -U postgres -d fortuna -f /tmp/ensure_cve_tables.sql
