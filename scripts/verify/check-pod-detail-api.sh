#!/usr/bin/env bash
# Check Pod Detail API: login with env-provided admin password, list pods, get pod by id/uid, and show podIP, startTime, phase.
...
PASS="${POD_DETAIL_CHECK_PASS:-${FORTUNA_ADMIN_PASSWORD:-${FORTUNA_DEFAULT_ADMIN_PASSWORD:-Fortuna_ChangeMe_123!}}}"
